...
function websocket_logger(server) {
    ...
    */
    ...
    function prepare_socket() {
        ...
        storage_keys = [
            "teacher-tag", // Unused. In the future: whom do we authorize to receive data?
            "user-tag", // Unique per-user tag in the settings page
            "process-server", // Unused. Which server should we send to?
            "unique-id", // Unique ID set in the settings page
            "generated-id" // Autogenerated, for future forensics
        ]
        chrome.storage.sync.get(storage_keys, function(result) {
            ...
            /*if("generated-id" not in event['local-storage']){
                event['local-storage']['generated-id'] = unique_id();
                chrome.storage.sync.set(
                    'generated-id',
                    event['local-storage']['generated-id']
                );
            }*/
            console.log(event);
...
loggers_enabled = [
    ...
    /* Default in code is the learning-observer account.  This has been
