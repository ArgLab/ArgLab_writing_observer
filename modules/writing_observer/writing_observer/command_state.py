...
class TabState:
    ...
    last_timestamp: Optional[int] = None  # Client timestamp (ms) when this tab last received edits
    ...
    def _apply_cmd(self, cmd: dict, current_tab: str, event_timestamp: Optional[int] = None) -> None:
        ...
        if ty == "ucp":
            ...
            if name:
                ...
                if event_timestamp is not None:
                    if tstate.first_timestamp is None:
                        tstate.first_timestamp = event_timestamp
                    tstate.last_timestamp = event_timestamp
            return
